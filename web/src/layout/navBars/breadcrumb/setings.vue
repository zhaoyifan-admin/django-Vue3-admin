  ...
  <div class="layout-breadcrumb-seting">
    ...
    >
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.layout.fontFamily') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select v-model="getThemeConfig.fontFamily" placeholder="Select" size="small" style="width: 90px"
                       @change="onChangeFontFamily">
              <el-option
                  v-for="item in state.fontFamilyOptions"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
              />
...
const onChangeFontFamily = (fontFamily: string) => {
  if (fontFamily !== 'defult') {
    document.body.setAttribute('style', `font-family: ${fontFamily}, serif`);
  } else {
